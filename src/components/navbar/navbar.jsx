...
function Navbar() {
    ...
    const [activeItem, setActiveItem] = useState(0); // State to track active item index
    ...
    return (
        <section className={Style.container}>
            ...
            <div onClick={openAsideMenu} className={Style.burgerMenu}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path d="M7 8H12M7 12H17M12 16H17" stroke="#040D08" stroke-width="1.5" stroke-linecap="round" />
                </svg>
            </div>
            ...
            <nav className={Style.navItems}>
                {navItems.map((item, index) => (
                    <Link
                        key={index}
                        to={item.router}
                        className={index === activeItem ? Style.activeNavItem : ''}
            ...
            {activeAside && <AsideMenu onClose={openAsideMenu}/> }
        </section>
    );
}
